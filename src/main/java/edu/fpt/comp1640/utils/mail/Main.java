...
public class Main {
    ...
    public static void main(String[] args) {
        final String FROM_USER_EMAIL = "duclmgch15319@fpt.edu.vn";//args[0];
        final String FROM_USER_FULLNAME = "Le Minh Duc"; //args[1];
        final String FROM_USER_ACCESSTOKEN = ""; //args[2];
        final String TO_USER_EMAIL = "duclmdev@gmail.com";// args[3];
